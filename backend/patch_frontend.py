...
NEW_SCRIPT = r"""  <script>
    ...
    async function scoreDonation() {
      ...
      if (await backendAvailable()) {
        try {
          ...
          renderSafetyFromAPI(res.safety_score, res.safety_label);
    ...
    function renderSafetyFromAPI(score, label) {
      ...
      text.textContent = score; title.textContent = label.title; details.textContent = label.details;
